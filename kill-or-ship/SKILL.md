...
**출력 전 안티패턴 자가 검출**
FEEDBACK 텍스트를 출력하기 전 다음을 확인한다. 하나라도 있으면 수정 후 출력한다.
- Em dash (—, –) 0건. 마침표, 쉼표, 콜론으로 대체.
- 빈 강조어 0건. (정말, 진짜, 매우, 굉장히, 아주, 엄청)
- 클리셰 동사·형용사 0건. (성장했다, 도전했다, 혁신적인, 획기적인)
- 가정형 0건. (할 뻔했다, 였을 것이다, 했을 수도 있다)
- 영어 calque 0건. (기본적으로, 본질적으로, 결국에는, 사실상, 한편으로는)
- 빈 호칭·권유 0건. (여러분, 당신, ~해보세요, ~하시면 됩니다)
- 빈 hedge 남용 0건. (어쩌면, 아마도, 어느 정도 — 한 단락 2회 초과 시)
- 복문 과다 0건. (한 문장에 절이 4개 이상이면 짧은 단문으로 분리)
- 긴 단락 0건. (한 단락 5문장 초과 시 분리)
